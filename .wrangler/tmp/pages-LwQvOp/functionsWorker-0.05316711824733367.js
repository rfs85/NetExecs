...
var jsonSchema = z2.union([literalSchema, z2.record(z2.any()), z2.array(z2.any())]);
var bufferSchema = z2.custom((v2) => v2 instanceof Buffer);
...
var insertTutorialSchema = createInsertSchema(tutorials).pick({
  title: true,
  slug: true,
  image: true,
  description: true,
...
var savedCommands = pgTable("saved_commands", {
  id: serial("id").primaryKey(),
  name: text("name").notNull(),
...
var insertSavedCommandSchema = createInsertSchema(savedCommands).pick({
  name: true,
  userId: true,
  protocol: true,
  target: true,
...
var storage = {
  ...
  async getModulesByProtocol(protocolName) {
  ...
  async getModuleByName(protocolName, moduleName) {
    const protocolResults = await db.select().from(protocols).where(eq(protocols.name, protocolName));
    if (!protocolResults.length) return void 0;
    const protocolId = protocolResults[0].id;
...
var onRequestGet = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    return new Response(JSON.stringify(modules2.map(mapId)), {
...
var onRequestGet2 = /* @__PURE__ */ __name(async (context) => {
  try {
    const protocols2 = await storage.getProtocols();
    return new Response(JSON.stringify(protocols2.map(mapId2)), {
      headers: { "Content-Type": "application/json" }
    });
  } catch {
...
var onRequestGet3 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    return new Response(JSON.stringify(commands.map(mapId3)), {
      headers: { "Content-Type": "application/json" }
    });
  } catch {
...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    return new Response(JSON.stringify(mapId3(savedCommand)), {
      status: 201,
      headers: { "Content-Type": "application/json" }
    });
  } catch {
...
var onRequestGet4 = /* @__PURE__ */ __name(async (context) => {
  try {
    const tutorials2 = await storage.getTutorials();
    return new Response(JSON.stringify(tutorials2), {
      headers: { "Content-Type": "application/json" }
    });
  } catch {
...
var onRequestGet5 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    const modules2 = await storage.getModulesByProtocol(protocol);
    return new Response(JSON.stringify(modules2.map(mapId4)), {
      headers: { "Content-Type": "application/json" }
    });
  } catch {
    return new Response(JSON.stringify({ message: "Failed to fetch modules" }), { status: 500 });
...
var onRequestGet6 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    return new Response(JSON.stringify(mapId5(module)), {
      headers: { "Content-Type": "application/json" }
    });
  } catch {
...
var onRequestGet7 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    return new Response(JSON.stringify(mapId6(tutorial)), {
      headers: { "Content-Type": "application/json" }
    });
  } catch {
...
// ../.wrangler/tmp/pages-LwQvOp/functionsRoutes-0.10938193060379464.mjs
var routes = [
  {
...
// C:/Users/ruben/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/ruben/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
